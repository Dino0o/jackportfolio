...
export default function NavBar(){
    return(
        <nav className="w-full bg-cyan-600 h-16 flex items-center px-1	" style={{ position: "fixed", top: 0, zIndex: 100 }}>
            ...
            <div className="ml-auto p-5 text-white"><a href="/">Home</a></div>
            <div className="p-5 text-white"><a href="/projects">Projects</a></div>
            <div className="p-5 text-white"><a href="https://www.linkedin.com/in/jack-degesero/" target="_blank">LinkedIn</a></div>
        </nav>
    );
};